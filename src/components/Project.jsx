...
const Project = () => {
  return (
    ...
    <div className="flex justify-center items-center gap-10 p-10">
      <span className="text-5xl font-bold font-serif animate-pulse">projects</span>
    </div>
...
<div className="card bg-base-100 w-96 shadow-xl pt-20 pb-5 animate-pulse">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-around">
            ...
            >
              <button className="btn btn-outline btn-accent" onClick={()=>window.open('https://github.com/Ajaynirm/Laptop-Management', '_blank')}>Git Hub</button>
            </div>
            <div className="lg:tooltip" data-tip="click to use this app">
              <button className="btn btn-outline btn-primary" onClick={()=>window.open('https://laptop-management-4.onrender.com/', '_blank')}>Live Demo</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card bg-base-100 w-96 shadow-xl pt-20 pb-5 animate-pulse">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-around">
            ...
            <div className="lg:tooltip" data-tip="click to use this app">
              <button className="btn btn-outline btn-primary" onClick={()=>window.open('https://securechat-ubs1.onrender.com/login', '_blank')}>Live Demo</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card bg-base-100 w-96 shadow-xl pt-20 pb-5 animate-pulse">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-around">
            ...
            <div className="lg:tooltip" data-tip="click to use this app">
              <button className="btn btn-outline btn-primary" onClick={()=>window.open('https://insta-clone-indol-five.vercel.app/', '_blank')}>Live Demo</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-around">
            <div
              ...
              data-tip="click to see the documentation"
            >
              <button className="btn btn-outline btn-accent" onClick={()=>window.open('https://github.com/Ajaynirm/cricketScore', '_blank')}>Git Hub</button>
            </div>
            <div className="lg:tooltip" data-tip="click to use this app">
              <button className="btn btn-outline btn-primary" onClick={()=>window.open('https://cricket-score-counter-alpha.vercel.app/', '_blank')}>Live Demo</button>
            </div>
          </div>
        </div>
      </div>
